...
const NAV_LINKS = [
  ...
  { label: 'Waste Analytics', to: '/waste-analytics' },
    ...
    <nav className="fixed top-0 w-full z-50 glass-nav shadow-sm">
      <div className="flex justify-between items-center px-6 py-3 max-w-full mx-auto">
        ...
        <div className="flex items-center gap-4">
          <Link
            to="/profile"
            className="flex items-center gap-2 rounded-full pl-2 pr-3 py-1.5 hover:bg-emerald-100/50 transition-all duration-300"
          >
