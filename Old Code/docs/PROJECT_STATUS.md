...
| Database | PostgreSQL 17.6 (AWS RDS — instance: `trolley-for-tomorrow`, region: `ap-southeast-2`) — Connected and ready |
| Backend API | Deployed on Azure App Service, health endpoint live — https://trolley-for-tomorrow-api-deg4hzdkdyfsb8he.australiaeast-01.azurewebsites.net |
| Hosting | Azure App Service F1 free tier, Australia East |
