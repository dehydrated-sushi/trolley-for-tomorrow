...
| Live URL | https://trolley-for-tomorrow-api-deg4hzdkdyfsb8he.australiaeast-01.azurewebsites.net |
| Auto-deploy | Triggers on push to `production` branch via GitHub Actions |
| Startup command | `cd backend && gunicorn --bind=0.0.0.0 --timeout 600 "app:create_app()"` |
